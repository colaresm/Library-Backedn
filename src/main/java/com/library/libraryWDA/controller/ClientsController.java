...
import com.library.libraryWDA.controller.docs.ClientsControllerDocs;
...
public class ClientsController implements ClientsControllerDocs {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<ClientDetailsResponse> getClientById(@PathVariable("id")  UUID id) {
        return new ResponseEntity<>( professionalService.getClientById(id), HttpStatus.OK);
    }
}
